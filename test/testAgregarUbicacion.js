...
try {
    ...
    await asociarUbicacion(daoMascotas, 1, direccionDeOrigen)

    const direccionDeOrigen2 = "Yatay 440, Almagro, Capital Federal, Argentina"
    await asociarUbicacion(daoMascotas, 2, direccionDeOrigen2)
    
    const direccionDeOrigen3 = "Yatay 640, Almagro, Capital Federal, Argentina"
    await asociarUbicacion(daoMascotas, 3, direccionDeOrigen3)
